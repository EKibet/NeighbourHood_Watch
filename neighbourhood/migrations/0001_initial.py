# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-10-20 20:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='neighbourhood.Neighbourhood')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('community', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='population', to='neighbourhood.Neighbourhood')),
            ],
        ),
        migrations.AddField(
            model_name='post',
